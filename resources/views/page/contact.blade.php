        ...
        <form method="post" action="contact">
            ...
            <fieldset>
                <div class="clearfix">
                    ...
                    <div class="input">
                        <input tabindex="1" size="18" id="name" name="name" type="text" class="input-xlarge" value="{{$customerlogin->name}}">
                    </div>
                </div>
                ...
                <div class="clearfix">
                    ...
                    <div class="input">
                        <input tabindex="2" size="25" id="email" name="email" type="text" class="input-xlarge" placeholder="" value="{{$customerlogin->email}}">
                    </div>
                </div>
                <div class="clearfix">
            ...
            <fieldset>
                <div class="clearfix">
                    <label for="name"><span>Tên:</span></label>
                    <div class="input">
                    <input tabindex="1" size="18" id="name" name="name" type="text" class="input-xlarge" placeholder="">
                    </div>
                </div>
                ...
                <div class="clearfix">
                    <label for="email"><span>Email:</span></label>
                    <div class="input">
                        <input tabindex="2" size="25" id="email" name="email" type="text" class="input-xlarge" placeholder="">
                    </div>
                </div>
