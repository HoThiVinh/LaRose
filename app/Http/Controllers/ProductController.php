...
class ProductController extends Controller
{
    ...
    {
        return Product::with('tags', 'images', 'attributes', 'review')->get();
    }
    ...
    {
        return Product::with('tags', 'images', 'attributes', 'review')->find($id);
    }
    ...
    {
        $product = Product::whereRaw('MATCH (name, description) AGAINST (?)', array($query));
        return $product->get();
    }
}